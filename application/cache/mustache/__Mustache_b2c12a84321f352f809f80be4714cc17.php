...
class __Mustache_b2c12a84321f352f809f80be4714cc17 extends Mustache_Template
{
...
';
        // 'isLoginPage' section
        $buffer .= $this->section2a34fa8fde5a346d4c8900c21333964b($context, $indent, $context->find('isLoginPage'));
        $buffer .= $indent . '	</script>
';
        $buffer .= $indent . '</html>';
    ...
    private function section2a34fa8fde5a346d4c8900c21333964b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
